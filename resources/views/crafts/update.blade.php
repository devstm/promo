        ...
        <form class="kt-form kt-form--label-right" action="{{route('crafts.store')}}" method="post">
            ...
            <div class="kt-portlet__body">
                <div class="form-group row">
                    ...
                    <div class="col-10">
                        <input class="form-control" type="text" name="name" value="{{$craft->name}}" placeholder="crafts name"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-10">
                        <input class="form-control" type="text" name="describe" value="{{$craft->describe}}" placeholder="describe" id="describe">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="describe" class="col-2 col-form-label"> {{__('crafts.$crafts')}}</label>
                    <div class="col-10">
