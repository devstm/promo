            ...
            <div class="kt-portlet">
                ...
                <div class="kt-portlet__body">
                    <a href="{{  url('category/create')}}">
                        <button type="button"
                                class="btn btn-primary btn-lg btn-block"> {{ __('categories.addNew')}}</button>
                    </a>
                    <!--begin::Section-->
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button type="button" class="bt btn-secondary"><a
                                                        href="{{route("category.edit",$val->id)}}">{{__('categories.Edit')}}</a>
                                                </button>
                                            </td>
                                            <td>
                                                <form action="{{ route('category.destroy',$val->id) }}" method="POST">
                                                    ...
                                                    @method('DELETE')
                                                    <button type="submit"
                                                            class="btn btn-danger">  {{ __('categories.delete')}}</button>
                                                </form>
                                            </td>
                                        </tr>
                                    @endforeach
